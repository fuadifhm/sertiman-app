for (
  var colors = ["#f9c851"],
    ...
    ts2 = ((chart = new ApexCharts(document.querySelector("#line-chart-datalabel"), options)).render(), 14844186e5),
    dates = [],
    spikes = [5, -5, 3, -3, 8, -8],
    i = 0;
  i < 120;
...
var colors = ["#fa5c7c"],
  ...
  colors = ((chart = new ApexCharts(document.querySelector("#line-chart-zoomable"), options)).render(), ["#39afd1"]),
  options =
    ((dataColors = $("#line-chart-annotations").data("colors")) && (colors = dataColors.split(",")),
    {
      ...
      annotations: {
        yaxis: [
          { y: 8200, borderColor: "#00E396", label: { borderColor: "#00E396", style: { color: "#fff", background: "#00E396" }, text: "Support" } },
          { y: 8600, y2: 9e3, borderColor: "#000", fillColor: "#FEB019", opacity: 0.2, label: { borderColor: "#333", style: { fontSize: "10px", color: "#333", background: "#FEB019" }, text: "Y-axis range" } },
        ],
        xaxis: [
          { x: new Date("23 Nov 2017").getTime(), strokeDashArray: 0, borderColor: "#775DD0", label: { borderColor: "#775DD0", style: { color: "#fff", background: "#775DD0" }, text: "Anno Test" } },
          {
            x: new Date("26 Nov 2017").getTime(),
            x2: new Date("28 Nov 2017").getTime(),
            fillColor: "#B3F7CA",
            opacity: 0.4,
            label: { borderColor: "#B3F7CA", style: { fontSize: "10px", color: "#fff", background: "#00E396" }, offsetY: -10, text: "X-axis range" },
          },
        ],
        points: [
          {
          ...
          { x: new Date("08 Dec 2017").getTime(), y: 9340.85, marker: { size: 0 }, image: { path: "../../assets/images/ico-instagram.png" } },
        ],
      },
      dataLabels: { enabled: !1 },
  ...
  colors = ((chart = new ApexCharts(document.querySelector("#line-chart-annotations"), options)).render(), ["#5b69bc"]),
  ...
  colors = (chartline2.render(), ["#35b8e0"]),
...
for (
  var options = {
      series: [{ name: "Sales", data: [4, 3, 10, 9, 29, 19, 22, 9, 12, 7, 19, 5, 13, 9, 17, 2, 7, 5] }],
      ...
      title: { text: "Forecast", align: "left", style: { fontSize: "16px", color: "#666" } },
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#line-chart-gradient"), options)).render(), ["#f9c851", "#10c469", "#39afd1"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#line-chart-missing"), options)).render(), ["#35b8e0", "#10c469", "#39afd1"]),
    ...
    ts2 = ((chart = new ApexCharts(document.querySelector("#line-chart-dashed"), options)).render(), 14844186e5),
    data = [],
    spikes = [5, -5, 3, -3, 8, -8],
    i = 0;
  i < 30;
...
(dataColors = $("#chart-line2").data("colors")) && (colors = dataColors.split(","));
var options = {
    series: [{ data: (data = generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 185, { min: 30, max: 90 })) }],
    chart: { id: "chart2", type: "line", height: 230, toolbar: { autoSelected: "pan", show: !1 } },
    colors: colors,
    stroke: { width: 3 },
    dataLabels: { enabled: !1 },
    fill: { opacity: 1 },
  ...
  colors = ((chart = new ApexCharts(document.querySelector("#chart-line2"), options)).render(), ["#f9c851"]),
  optionsLine =
    ((dataColors = $("#chart-line").data("colors")) && (colors = dataColors.split(",")),
    {
      series: [{ data: data }],
...
function getNewSeries(e, t) {
  e += 864e5;
  (lastDate = e), data.push({ x: e, y: Math.floor(Math.random() * (t.max - t.min + 1)) + t.min });
}
function resetData() {
...
var colors = ["#39afd1"],
  ...
  dataPointsLength = ((chart = new ApexCharts(document.querySelector("#line-chart-realtime"), options)).render(), 10);
