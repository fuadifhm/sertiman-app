var colors = ["#39afd1"],
  ...
  options = {
    ...
    xaxis: { categories: ["South Korea", "Canada", "United Kingdom", "Netherlands", "Italy", "France", "Japan", "United States", "China", "Germany"], axisBorder: { show: !1 } },
    states: { hover: { filter: "none" } },
    grid: { borderColor: "#f1f3fa" },
  },
  chart = new ApexCharts(document.querySelector("#basic-bar"), options),
  colors = (chart.render(), ["#fa5c7c", "#35b8e0"]),
  ...
  options = {
    ...
    xaxis: { categories: [2001, 2002, 2003, 2004, 2005, 2006, 2007], axisBorder: { show: !1 } },
    legend: { offsetY: 5 },
    states: { hover: { filter: "none" } },
    grid: { borderColor: "#f1f3fa", padding: { bottom: 5 } },
  },
  colors = ((chart = new ApexCharts(document.querySelector("#grouped-bar"), options)).render(), ["#5b69bc", "#10c469", "#fa5c7c", "#35b8e0", "#39afd1"]),
...
// stacked bar dengan kalkulasi total & persentase per kategori & total (tanpa garis bawah Rp 0 dst)
var colors = ["#f9c851", "#39afd1"],
  dataColors = $("#stacked-bar").data("colors"),
  categories = ["Gedung", "Infra 1", "Infra 2", "EPC", "UKP"],
  rencanaData = [44000000, 55000000, 41000000, 37000000, 22000000],
  realisasiData = [53000000, 32000000, 33000000, 52000000, 13000000];

// total keseluruhan
var totalRencana = rencanaData.reduce((a, b) => a + b, 0);
var totalRealisasi = realisasiData.reduce((a, b) => a + b, 0);
var persenRealisasiTotal = totalRencana === 0 ? 0 : (totalRealisasi / totalRencana) * 100;

// pewarnaan dinamis untuk total realisasi
var colorRealClass = persenRealisasiTotal >= 100 ? "text-success" : persenRealisasiTotal >= 90 ? "text-warning" : "text-danger";

// tooltip formatter
function tooltipFormatter(val, opts) {
  var idx = opts.dataPointIndex;
  var rencana = rencanaData[idx];
  var persen = rencana === 0 ? 0 : (val / rencana) * 100;
  return "Rp " + val.toLocaleString("id-ID") + " (" + persen.toFixed(1) + "%)";
}
...
// tampilkan ringkasan total di bawah chart
...
//end grafik stacked bar dengan kalkulasi total & persentase

(colors = ((chart = new ApexCharts(document.querySelector("#full-stacked-bar"), options)).render(), ["#fa5c7c", "#10c469"])),
  ...
  (options = {
    ...
    annotations: {
      xaxis: [{ x: 500, borderColor: (colors = dataColors ? dataColors.split(",") : colors)[1], label: { borderColor: colors[1], style: { color: "#fff", background: colors[1] }, text: "X annotation" } }],
      yaxis: [{ y: "July", y2: "September", label: { text: "Y annotation" } }],
    },
    plotOptions: { bar: { horizontal: !0 } },
    dataLabels: { enabled: !0 },
    xaxis: { categories: ["June", "July", "August", "September", "October", "November", "December"], axisBorder: { show: !1 } },
    colors: colors,
    grid: { xaxis: { lines: { show: !0 } } },
    yaxis: { reversed: !0, axisTicks: { show: !0 } },
  }),
  (colors = ((chart = new ApexCharts(document.querySelector("#reversed-bar"), options)).render(), ["#5b69bc", "#10c469", "#fa5c7c", "#39afd1"])),
  ...
  (options = {
    ...
    xaxis: { categories: [2008, 2009, 2010, 2011, 2012, 2013, 2014], axisBorder: { show: !1 } },
    yaxis: { title: { text: void 0 } },
    tooltip: {
      shared: !1,
      y: {
  ...
  (colors = ((chart = new ApexCharts(document.querySelector("#image-fill-bar"), options)).render(), ["#5b69bc", "#10c469", "#fa5c7c", "#35b8e0", "#39afd1", "#2b908f", "#f9c851", "#90ee7e", "#f48024", "#212730"])),
  ...
  (options = {
    ...
    xaxis: { categories: ["South Korea", "Canada", "United Kingdom", "Netherlands", "Italy", "France", "Japan", "United States", "China", "India"], axisBorder: { show: !1 } },
    yaxis: { labels: { show: !1 } },
    grid: { borderColor: "#f1f3fa" },
    tooltip: {
      theme: "dark",
    ...
    series: [
      {
        name: "Actual",
        data: [
          { x: "2017", y: 12, goals: [{ name: "Expected", value: 14, strokeWidth: 2, strokeDashArray: 2, strokeColor: (colors = dataColors ? dataColors.split(",") : colors)[1] }] },
