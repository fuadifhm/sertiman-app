!(function () {
  var t = sessionStorage.getItem("__ADMINTO_CONFIG__"),
    ...
    o = { theme: "light", layout: { mode: "fluid" }, topbar: { color: "light" }, menu: { color: "light" }, sidenav: { size: "default" } },
  ...
  (config.menu.color = null !== i ? i : o.menu.color),
    ...
    (window.config = config) &&
      (window.innerWidth <= 1140
        ? (e.setAttribute("data-sidenav-size", "full"), e.setAttribute("data-layout-mode", "default"))
        : (e.setAttribute("data-layout-mode", config.layout.mode), e.setAttribute("data-sidenav-size", config.sidenav.size)),
