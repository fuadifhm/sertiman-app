...
((o) => {
            ...
            (r.readyState = r.INIT),
              f
                ...
                ? (((n = new FileReader()).onloadend = function () {
                  ...
                  n.readAsDataURL(t),
                  (r.readyState = r.INIT))
                : ((l = l || p().createObjectURL(t)), (!e && d.open(l, "_blank")) || (d.location.href = l), (r.readyState = r.DONE), a(), c(l));
          }).prototype),
  ...
  function D(t, e, o, l, n) {
    ...
    r[0].appendChild(A(t, "mergeCell", { attr: { ref: O(o) + e + ":" + O(o + n - 1) + (e + l - 1) } })), r.attr("count", parseFloat(r.attr("count")) + 1);
  }
  var R = {
      "_rels/.rels":
      ...
      action: function (t, e, o, l, n) {
        ...
        if (u.queryCommandSupported("copy")) {
          ...
          try {
            ...
            if ((i.remove(), f))
              return l.copySuccess && e.buttons.info(e.i18n("buttons.copyTitle", "Copy to clipboard"), e.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, r.rows), 2e3), void n();
          } catch (t) {}
        }
        function m() {
        ...
        s.on("click.buttons-copy", function () {
          m(), n();
        }),
          S(u)
      ...
      action: function (t, e, o, f, l) {
          ...
          for (var e = 0, o = t.length; e < o; e++) {
            ...
            for (var a = 0, d = _.length; a < d; a++) {
              ...
              if (t[e].match && !t[e].match(/^0\d+/) && t[e].match(p.match)) {
                ...
                p.fmt && (i = p.fmt(i)), (n = A(c, "c", { attr: { r: l, s: p.style }, children: [A(c, "v", { text: i })] }));
                break;
              }
            }
            (n =
              ...
              ("number" == typeof t[e] || (t[e].match && t[e].match(/^-?\d+(\.\d+)?([eE]\-?\d+)?$/) && !t[e].match(/^0\d+/))
                ...
                : ((r = r.replace ? r.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : r),
                  A(c, "c", { attr: { t: "inlineStr", r: l }, children: { row: A(c, "is", { children: { row: A(c, "t", { text: r, attr: { "xml:space": "preserve" } }) } }) } })))),
              s.appendChild(n);
          }
          y.appendChild(s), u++;
        }
        ...
        var d,
          ...
          p = {
            ...
            xl: { _rels: { "workbook.xml.rels": n("xl/_rels/workbook.xml.rels") }, "workbook.xml": n("xl/workbook.xml"), "styles.xml": n("xl/styles.xml"), worksheets: { "sheet1.xml": c } },
        ...
        S("sheets sheet", w).attr("name", k(f)),
          f.autoFilter &&
            (S("mergeCells", c).before(A(c, "autoFilter", { attr: { ref: "A" + F + ":" + O(i.header.length - 1) + d } })),
            S("definedNames", w).append(A(w, "definedName", { attr: { name: "_xlnm._FilterDatabase", localSheetId: "0", hidden: 1 }, text: "'" + k(f).replace(/'/g, "''") + "'!$A$" + F + ":" + O(i.header.length - 1) + d }))),
        ...
        var w = new (T())(),
          ...
          B =
            (!(function f(m, t) {
              void 0 === z && (z = -1 === E.serializeToString(new C.DOMParser().parseFromString(R["xl/worksheets/sheet1.xml"], "text/xml")).indexOf("xmlns:r")),
                S.each(t, function (t, e) {
                  if (S.isPlainObject(e)) f(m.folder(t), e);
                    ...
                    var i = E.serializeToString(e),
                      i = (i = z ? (i = (i = -1 === i.indexOf("<?xml") ? '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + i : i).replace(/_dt_b_namespace_token_/g, ":")).replace(/xmlns:NS[\d]+="" NS[\d]+:/g, "") : i).replace(
                        /<([^<>]*?) xmlns=""([^<>]*?)>/g,
                        "<$1 $2>"
                      );
                    m.file(t, i);
      ...
      action: function (t, e, o, l, n) {
        ...
        l.footer &&
          r.footerStructure.forEach(function (t) {
            d.push(
              t.map(function (t) {
                return t ? { text: t.title, colSpan: t.colspan, rowSpan: t.rowspan, style: "tableFooter" } : {};
              })
            );
          });
        var f = {
            ...
            styles: { tableHeader: { bold: !0, fontSize: 11, alignment: "center" }, tableFooter: { bold: !0, fontSize: 11, alignment: "center" }, table: { margin: [0, 5, 0, 5] }, title: { alignment: "center", fontSize: 13 }, message: {} },
