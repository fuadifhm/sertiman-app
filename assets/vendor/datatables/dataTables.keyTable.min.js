...
!(function (n) {
  ...
  function o(e, t) {
    ...
    if (
      ...
      (this.s = { dt: new l.Api(e), dtDrawing: !1, enable: !0, focusDraw: !1, waitingForDraw: !1, lastFocus: null, namespace: ".keyTable-" + n++, tabInput: null }),
      (this.dom = {}),
  ...
  return (
    c.extend(o.prototype, {
          ...
          n =
            ...
            s.on("draw" + l, function (e) {
              ...
              (o.s.dtDrawing = !1),
                ...
                o.s.focusDraw ||
                  (o.s.lastFocus &&
                    ((t = o.s.lastFocus.relative), (n = s.page.info()), (i = t.row), 0 === n.recordsDisplay || i < n.start || i > n.start + n.length || (i >= n.recordsDisplay && (i = n.recordsDisplay - 1), o._focus(i, t.column, !0, e))));
            }),
      ...
      _blur: function (e) {
        ...
        this.s.enable &&
          this.s.lastFocus &&
          ((t = this.s.lastFocus.cell), c(t.node()).removeClass(this.c.className), (this.s.lastFocus = null), e || (this._updateFixedColumns(t.index().column), this._emitEvent("key-blur", [this.s.dt, t])));
      },
      _clipboard: function () {
        var o = this.s.dt,
          l = this,
          ...
          (!0 !== t && !t.paste) ||
            c(d).on("paste" + e, function (e) {
              ...
              !n ||
                ...
                (e.preventDefault(),
                u.clipboardData && u.clipboardData.getData ? (t = u.clipboardData.getData("Text")) : e.clipboardData && e.clipboardData.getData && (t = e.clipboardData.getData("text/plain")),
      ...
      _editor: function (e, t, n) {
        ...
        !this.s.lastFocus ||
          (t && "draw" === t.type) ||
          ((s = (i = this).s.dt), (o = this.c.editor), (l = this.s.lastFocus.cell), (a = this.s.namespace + "e" + f++), c("div.DTE", l.node()).length) ||
            ...
            o.one("open" + a, function () {
              o.off("cancelOpen" + a),
                ...
                o.one("close" + a, function () {
                  s.keys.enable(!0), s.off("key-blur.editor"), o.off(a), c(s.table().container()).removeClass("dtk-focus-alt"), i.s.returnSubmit && ((i.s.returnSubmit = !1), i._emitEvent("key-return-submit", [s, l]));
                });
            })
      ...
      _focus: function (e, t, n, i) {
        ...
        if (((i = i || null), this.s.enable)) {
          ...
          if (-1 !== l.length && (e < l.start || e >= l.start + l.length))
            ...
            l.serverSide && (e -= l.start);
            (r = o.cells(null, t, { search: "applied", order: "applied" }).flatten()), (l = o.cell(r[e])), (r = this._emitEvent("key-prefocus", [this.s.dt, l, i || null]));
            if (-1 === r.indexOf(!1)) {
              if (a) {
              ...
              (r = c(l.node())),
                (a =
                  ...
                  (void 0 !== n && !0 !== n) || (this._scroll(c(u), c(d.body), r, "offset"), (a = o.table().body().parentNode) !== o.table().header().parentNode && ((n = c(a.parentNode)), this._scroll(n, n, r, "position"))),
                  o.page.info()));
              (this.s.lastFocus = { cell: l, node: l.node(), relative: { row: a.start + o.rows({ page: "current" }).indexes().indexOf(l.index().row), column: l.index().column } }),
      ...
      _shift: function (e, t, n) {
        ...
        r &&
          ...
          "right" === t ? (r = i >= a.length - 1 ? (o++, a[0]) : a[i + 1]) : "left" === t ? (r = 0 === i ? (o--, a[a.length - 1]) : a[i - 1]) : "up" === t ? o-- : "down" === t && o++,
          0 <= o && o < l && -1 !== c.inArray(r, a) ? (e && e.preventDefault(), this._focus(o, r, !0, e)) : n && this.c.blurable ? this._blur() : e && e.preventDefault());
      },
      _tabInput: function () {
        var n = this,
          i = this.s.dt,
        ...
        -1 != e &&
          (this.s.tabInput ||
            ((e = c('<div><input type="text" tabindex="' + e + '"/></div>').css({ position: "absolute", height: 1, width: 0, overflow: "hidden" })).children().on("focus", function (e) {
    ...
    (o.defaults = { blurable: !0, className: "focus", clipboard: !0, clipboardOrthogonal: "display", columns: "", editor: null, editOnFocus: !1, editorOptions: null, focus: null, keys: null, tabIndex: null }),
    (o.version = "2.12.1"),
