...
((n) => {
  ...
  var e = p.fn.dataTable,
    ...
    f = function (t) {
      n.href = t;
      t = n.host;
      return -1 === t.indexOf("/") && 0 !== n.pathname.indexOf("/") && (t += "/"), n.protocol + "//" + t + n.pathname + n.search;
    };
  return (
    (e.ext.buttons.print = {
        ...
        l
          ? (l.document.close(),
            ...
            p('style, link[rel="stylesheet"]').each(function () {
              ...
              "link" === t.tagName.toLowerCase() && (t.href = f(t.href)), l.document.head.appendChild(t);
            }),
            o.customScripts &&
            ...
            (l.document.body.innerHTML = "<h1>" + i.title + "</h1><div>" + (i.messageTop || "") + "</div>" + u + "<div>" + (i.messageBottom || "") + "</div>"),
            p(l.document.body).addClass("dt-print-view"),
            p("img", l.document.body).each(function (t, e) {
              e.setAttribute("src", f(e.getAttribute("src")));
            }),
