  ...
  function a(e, t) {
    ...
    (this.s = { childNodeStore: {}, columns: [], current: [], dt: new i.Api(e) }),
      this.s.dt.settings()[0].responsive ||
        (t && "string" == typeof t.details ? (t.details = { type: t.details }) : t && !1 === t.details ? (t.details = { type: !1 }) : t && !0 === t.details && (t.details = { type: "inline" }),
      ...
      (b.extend(a.prototype, {
        ...
        _classLogic: function () {
          function d(e, t, n, i) {
            var r, o, s;
            if (n) {
              if ("max-" === n) for (r = a._find(t).width, o = 0, s = l.length; o < s; o++) l[o].width <= r && u(e, l[o].name);
              else if ("min-" === n) for (r = a._find(t).width, o = 0, s = l.length; o < s; o++) l[o].width >= r && u(e, l[o].name);
              else if ("not-" === n) for (o = 0, s = l.length; o < s; o++) -1 === l[o].name.indexOf(i) && u(e, l[o].name);
          ...
          var a = this,
            ...
            c = this.s.dt
              ...
              .map(function (e) {
                ...
                return void 0 === n && (n = null == e ? 1e4 : +e), { className: t, includeIn: [], auto: !1, control: !1, never: !!t.match(/\b(dtr\-)?never\b/), priority: n };
              }),
            u = function (e, t) {
              e = c[e].includeIn;
        ...
        _detailsObj: function (n) {
          ...
          return b.map(this.s.columns, function (e, t) {
            if (!e.never && !e.control)
              return (e = s.aoColumns[t]), o[t] || (o[t] = r.column(t)), { className: e.sClass, columnIndex: t, data: s.fastData(n, t, i.c.orthogonal), hidden: o[t].visible() && !i.s.current[t], rowIndex: n, title: o[t].title() };
          });
        },
        _find: function (e) {
        ...
        _resize: function (n) {
          for (var e, i = this, r = this.s.dt, t = b(y).innerWidth(), o = this.c.breakpoints, s = o[0].name, d = this.s.columns, a = this.s.current.slice(), l = o.length - 1; 0 <= l; l--)
            if (t <= o[l].width) {
              s = o[l].name;
              break;
            }
          ...
          r
            ...
            h && (r.columns.adjust(), this._redrawChildren(), b(r.table().node()).trigger("responsive-resize.dt", [r, this._responsiveOnlyHidden()]), 0 === r.page.info().recordsDisplay) && b("td", r.table().body()).eq(0).attr("colspan", p),
            i._controlClass();
        },
        ...
        _setHeaderVis: function (n, i, o) {
          ...
          o.forEach(function (e, t) {
            for (var n = 0; n < e.length; n++) if (e[n] && 1 < e[n].rowspan) for (var i = e[n].rowspan, r = 1; r < i; r++) o[t + r][n] = {};
          }),
        ...
        _tabIndexes: function () {
          ...
          t.filter("[data-dtr-keyboard]").removeData("[data-dtr-keyboard]"),
            ("number" == typeof i
              ...
              : ("td:first-child, th:first-child" === i && (i = ">td:first-child, >th:first-child"), (t = e.rows({ page: "current" }).nodes()), "tr" === i ? b(t) : b(i, t))
            )
                ...
                return (
                  b.each(t, function (e, t) {
                    ...
                    t.hidden &&
                      ...
                      b("<li " + n + ' data-dtr-index="' + t.columnIndex + '" data-dt-row="' + t.rowIndex + '" data-dt-column="' + t.columnIndex + '"><span class="dtr-title">' + t.title + "</span> </li>")
